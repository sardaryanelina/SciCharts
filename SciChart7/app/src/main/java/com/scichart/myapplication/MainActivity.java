...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // -------------------------  Code was used from Tutorial 06  ---------------------------//
        ...
        // -------------------------  Tutorial 07 - Adding Annotations to the Chart  ---------------------------//

        // In this tutorial, we are going to build on the previous tutorial. We will add a bulletin type marker
        // (e.g., text, like a stock ticker or news item) to the chart.

        //To do this, we will modify the updateDataTask.

        //We create a TextAnnotation and add it to the Annotations collection of the SciChartSurface.
        // We use SciChartBuilder to create and configure the annotation.
