...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // -------------------------  Tutorial 06.3 - Scrolling Realtime (FIFO) Charts  ---------------------------//
        ...
        /*
         * The most memory efficient way to achieve scrolling is to call setFifoCapacity() on a DataSeries to set
         * the maximum size of a DataSeries before old points are discarded. DataSeries in FIFO mode act as a circular
         * (first-in-first-out) buffer. Once the capacity is exceeded, old points are discarded. You cannot zoom back to see the old points,
         * once they are lost, they are lost.
         * To make a DataSeries use the FIFO buffer, you have to set fifo capacity on the DataSeries,
         * which defines the size of the FIFO buffer. The code from our application should be rewritten
         * like the following to utilize a FIFO buffer: */
