...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // -----------------------------------  Code used from Tutorial 01 - - Creating a Chart ----------------------------//
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            scatterData.append(i, Math.cos(i * 0.6));
        }
        ...
        final IRenderableSeries lineSeries = sciChartBuilder.newLineSeries()
                ...
                .withStrokeStyle(ColorUtil.Teal, 2f, true)
                .build();
...
//        Similarly we can create a Scatter series. It requires a PointMarker instance.
        EllipsePointMarker pointMarker = sciChartBuilder
                ...
                .withFill(ColorUtil.PaleVioletRed)
                .withStroke(ColorUtil.Red, 1f)
                .withSize(6)
                .build();
